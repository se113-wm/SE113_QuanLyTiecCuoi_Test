...
VALUES 
(N'Nguyễn Văn Đức', N'Trần Thị Nguyệt', '0912345678', '2025-05-10', '2025-06-20 10:00:00', 1, 1, 7000000, 27, 1, 1000000),
(N'Lê Văn Chí', N'Phạm Thị Tố', '0923456789', '2025-05-15', '2025-06-19 18:00:00', 2, 2, 7500000, 26, 1, 1000000),

(N'Nguyễn Văn Anh', N'Trần Thị Bé', '0912345678', '2025-05-10', '2025-06-24 10:00:00', 1, 1, 9000000, 27, 1, 1000000),

(N'Nguyễn Tự Tuấn', N'Trần Liễu My', '0912345678', '2025-05-10', '2025-06-20 18:00:00', 2, 1, 10000000, 27, 1, 1000000),

(N'Nguyễn Đại Lương', N'Trần Nữ Uyên', '0912345678', '2025-05-10', '2025-06-26 10:00:00', 1, 1, 9000000, 27, 1, 1000000);


INSERT INTO PHIEUDATTIEC (TenChuRe, TenCoDau, DienThoai, NgayDatTiec, NgayDaiTiec,
    MaCa, MaSanh, TienDatCoc, SoLuongBan, SoBanDuTru, DonGiaBanTiec)
VALUES 
(N'Hoàng Văn Mai', N'Ngô Thị Phấn', '0934567890', '2025-05-20', '2025-06-18 10:00:00', 1, 3, 8000000, 24, 0, 1100000),

(N'Lê Văn Cường', N'Phạm Thị Dương', '0923456789', '2025-05-15', '2025-06-24 18:00:00', 2, 2, 15000000, 26, 1, 1000000),
(N'Hoàng Văn E', N'Ngô Thị F', '0934567890', '2025-05-20', '2025-06-24 10:00:00', 1, 3, 8000000, 24, 0, 1100000),

(N'Lê Trọng Nghĩa', N'Phạm Tuyết Lan', '0923456789', '2025-05-15', '2025-06-19 10:00:00', 1, 2, 10500000, 26, 1, 1000000),

(N'Lê Tâm Việt', N'Phạm Xuân Nhi', '0923456789', '2025-05-15', '2025-06-27 18:00:00', 2, 2, 15000000, 26, 1, 1000000);

INSERT INTO PHIEUDATTIEC (TenChuRe, TenCoDau, DienThoai, NgayDatTiec, NgayDaiTiec,
    MaCa, MaSanh, TienDatCoc, SoLuongBan, SoBanDuTru, DonGiaBanTiec)
VALUES 
(N'Phan Văn Tài', N'Đỗ Thị Hồng', '0945678901', '2025-05-25', '2025-06-17 18:00:00', 2, 4, 9000000, 24, 0, 1100000),

(N'Phan Văn Giang', N'Đỗ Thị Hướng', '0945678901', '2025-05-25', '2025-06-24 18:00:00', 2, 4, 9000000, 22, 0, 1100000),

(N'Hoàng Mạnh Sơn', N'Ngô Quế Đài', '0934567890', '2025-05-20', '2025-06-18 18:00:00', 2, 3, 12000000, 24, 0, 1100000),
(N'Phan Chính Huy', N'Đỗ Mỹ Thanh', '0945678901', '2025-05-25', '2025-06-17 10:00:00', 1, 4, 9000000, 22, 0, 1100000),

(N'Hoàng Bảo Phát', N'Ngô Sương Vy', '0934567890', '2025-05-20', '2025-07-17 10:00:00', 1, 3, 8000000, 24, 0, 1100000);

INSERT INTO PHIEUDATTIEC (TenChuRe, TenCoDau, DienThoai, NgayDatTiec, NgayDaiTiec,
    MaCa, MaSanh, TienDatCoc, SoLuongBan, SoBanDuTru, DonGiaBanTiec)
VALUES 
(N'Trịnh Văn Tuấn', N'Bùi Thị Trinh', '0956789012', '2025-05-28', '2025-06-16 10:00:00', 1, 5, 9600000, 23, 1, 1200000),

(N'Trịnh Văn Yên', N'Bùi Thị Kiều', '0956789012', '2025-05-28', '2025-06-24 10:00:00', 1, 5, 9600000, 23, 1, 1200000),

(N'Trịnh Chương Sĩ', N'Bùi Liên Yến', '0956789012', '2025-05-28', '2025-06-16 18:00:00', 2, 5, 9600000, 23, 1, 1200000),

(N'Phan An Bình', N'Đỗ Oanh Ý', '0945678901', '2025-05-25', '2025-07-12 18:00:00', 2, 4, 9000000, 22, 0, 1100000),
(N'Trịnh Ninh Xuyên', N'Bùi Ánh Châu', '0956789012', '2025-05-28', '2025-07-11 10:00:00', 1, 5, 9600000, 23, 1, 1200000);
